...
nonisolated struct Subject: Hashable, Codable, Defaults.Serializable, Identifiable, Equatable {
	...
	func toSubjectEntity(identifier: String? = nil, timetable: IntentTimetableResolver.ResolvedTimetable) -> SubjectEntity {
		let entity = SubjectEntity(id: identifier ?? id, name: id, symbol: symbol, colour: colour, slots: slots, personName: timetable.displayName, teacherName: teacher.displayName, classroomName: classroom.displayName)
		#if !os(watchOS)
